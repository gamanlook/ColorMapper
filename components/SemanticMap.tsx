...
const SemanticMap: React.FC<SemanticMapProps> = ({ hue, data, currentColor, width = 360, height = 360 }) => {
  ...
  return (
    ...
    <div className="relative flex justify-center w-[calc(100%+3rem)] -mx-6 max-w-[480px] lg:max-w-[416px]">
      ...
      {hoveredCluster && (
        <div className="absolute -bottom-4 -right-2 lg:-bottom-16 lg:-right-6 bg-theme-toast-bg backdrop-blur-md p-4 rounded-2xl shadow-xl shadow-slate-700/10 dark:shadow-black/50 border border-theme-toast-border text-sm z-10 pointer-events-none transform transition-all duration-200 min-w-[160px]">
