...
function App() {
  ...
  return (
    <div className="min-h-screen bg-theme-page text-white relative overflow-x-hidden selection:bg-white/30">
      {/* Immersive Dynamic Background (Fixed Wallpaper) */}
      <div
        className="fixed inset-0 opacity-40 transition-colors duration-1000 ease-in-out pointer-events-none -z-10"
        style={{
          background: `radial-gradient(circle at 50% 30%, ${dynamicBgColor} 0%, transparent 70%)`,
        }}
      />

      {/* Noise Overlay for texture (Fixed Wallpaper) */}
      <div
        className="fixed inset-0 opacity-[0.9] pointer-events-none mix-blend-overlay -z-10"
        style={{
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row min-h-[150vh]">
