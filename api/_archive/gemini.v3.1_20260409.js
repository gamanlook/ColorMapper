 ...
 * 
 * 📝 特點描述：嘗試精簡版本（但太直男審視）
 * [V] Schema改成中文 (解決 橄欖被翻譯成橄欖石 問題)
 * [V] 思考順整理 (解決 尼哥白會通過 問題)
 * [V] 改用System Instructions
 * [V] 用字精簡、提煉精髓
 * [V] 讓AI把思考過程寫下來（模仿thinking，因為 flash-lite 沒有思考過程）
 * [V] 好好聊天（避免變成高高在上，不對用戶其他地方挑毛病，像是取名簡單或中庸之類的）
 * [ ] 防止籠統名字 (解決 單說「哀鳳色」「內衣色」會通過 問題)
 * [ ] 防止私人經驗名字  (解決「我媽的拖鞋」會通過 問題)
 * [ ] 台灣常識與全球常識 (解決AI以為 台股綠色是漲 問題)
 * [ ] 重新整理區塊職責（原本可能會放錯地方寫）：
...
export default async function handler(req) {
  ...
  try {
    ...
    const systemInstructionText = `
      ...
      【核心個性】：
      - 真實情感流露：真實反映你的情緒（傻眼、驚豔、無奈或共鳴等），讓反應立體且多變，讓對話充滿生命力
      ...
      *(色相H參考基準：桃348, 紅27, 橘54, 黃95, 綠141, 青210, 藍255, 紫302)*
      ...
      - 遇到胡鬧、挑釁或荒謬的留言：展現靈活的「吐槽藝術」。用一本正經講幹話、無奈傻眼，或更荒謬的邏輯反殺回去，陪他一起瘋
