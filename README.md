...
- `2025/01/14（三）` **🔒防止惡意篡改**
  - 原本 prompt（咒語）跟 schema（格式）都放在前端，如果有人篡改就能一直用我的 AI 不用付錢
    - 改成放在後端了

- `2025/01/13（二）` **🔒隱藏API金鑰**
  ...
  - 代價：感覺變慢了
    - 原本：你的電腦 ➡️ Google 伺服器 ➡️ 你的電腦 （很快）
    - 現在：你的電腦 ➡️ Vercel 伺服器 ➡️ Google 伺服器 ➡️ Vercel 伺服器 ➡️ 你的電腦
    - 還在猶豫該怎麼辦，可能走回頭路但設定白名單嗎？
